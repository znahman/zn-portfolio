...
const IndexPage: React.FC = () => (
    <Layout>
        <SEO title="Home" />
        <IDCard name="Zach Nahman" title="Software Engineer" pronouns="He/Him/His" />
        <ParagraphHeader title="hello world" />
        <p style={{ lineHeight: `1.6`, textAlign: `justify` }}>
            I am a Software Development Engineer at{` `}
            <ALink href="https://www.workday.com" linkText="Workday" />. 
            I love learning about the web and working with web applications. I've
        ...
        <p style={{ lineHeight: `1.6`, textAlign: `justify` }}>
            ...
            wife, Taylor and family. We've got a fiery cat named Gordon and a sweet 
            dog named Emma. I also enjoy exercising, playing video games, 
